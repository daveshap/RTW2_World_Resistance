...
- `WORLD_STATE` is the compact successful-reconciliation proof. It includes active AI, accepted base/catch-up bundle-command counts, treasury grant count/total, pressure/tier, and target armies.
