...
- the 0.1.5 explicit-registry, partial/repeated-setup, delayed-interface, campaign-predicate, per-turn faction-retry harness and protected bootstrap-trace assertions;
